...
public class SauceLabsAndroidAPP2{

	public static void main( String[] args ){
		
		List<pureCapability> driverCaps = pureConfig.loadCapabilitiesFromFile( "SauceLabsAndroidAPP.json" );		
		
		pureDriverDetails myDriver = pureDrivers.newPureDriver( "saucelabsandroidapp", driverCaps, false );
		...
		java.lang.reflect.Method[] mList = AndroidDriver.class.getMethods();
		for( int iLoop = 0; iLoop < mList.length; iLoop++ ) {
			System.out.println( "	// AndroidDriver		   [" + String.valueOf( iLoop ) + "] = " + mList[ iLoop ].toGenericString() );
		}
