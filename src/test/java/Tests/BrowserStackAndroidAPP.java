...
public class BrowserStackAndroidAPP{

	public static void main( String[] args ){
		
		List<pureCapability> driverCaps = pureConfig.loadCapabilitiesFromFile( "BrowserStackAndroidAPP.json" );		
		
		pureDriverDetails myDriver = pureDrivers.newPureDriver( "browserstackandroidapp", driverCaps, false );
