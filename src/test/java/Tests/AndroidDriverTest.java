...
public class AndroidDriverTest{
	...
	public static void main( String[] args ){
		...
		List<pureCapability> driverCaps = pureConfig.loadCapabilitiesFromFile( "AndroidSetup.json" );
		
		pureDriverDetails myDriver = pureDrivers.newPureDriver( "android", driverCaps, false );
