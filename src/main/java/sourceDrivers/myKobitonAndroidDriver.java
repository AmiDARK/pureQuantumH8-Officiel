...
public class myKobitonAndroidDriver {
	...
	private static String[] directCommands = {
			// Sauce Labs Commands :
			"sessionName", "sessionDescription", "deviceOrientation", "app", "deviceGroup", "deviceName",
	...
	public static void startDriver( pureDriverDetails myDriverDetails ) {
		if( myDriverDetails != null ) {
			String driverURL = "https://api.kobiton.com/wd/hub";
